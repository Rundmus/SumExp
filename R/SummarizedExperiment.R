...
#' @param ... Not used
#' @returns A [`SummarizedExperiment::SummarizedExperiment`] object with the row and column data
#    frames as well as the matrices. Each matrix '  in the [`SumExp`] object is stored in the
#    `assays` slot of the [`SummarizedExperiment::SummarizedExperiment`] object.
#' @export
setGeneric("as_SummarizedExperiment", function(x, ...) {
